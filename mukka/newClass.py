...
def classifyKNN():
    ...
    knn.fit(finalList,classList)
    k_score =knn.score(testFinalList,testClassList)
...
def Tree():
    ...
    regr_1.fit(finalList, classList)
    regr_2.fit(finalList,classList)	
    y_1 = regr_1.predict(testFinalList)
    y_2 = regr_2.predict(testFinalList)
    score1 = regr_1.score(testFinalList,testClassList)
    score2 = regr_2.score(testFinalList,testClassList)
...
def classifyPerceptronOnly():
	...
	res1 = clf_p.predict(testFinalList)
...
if __name__ == '__main__':
    # help menu
    walk_dir = "/mnt/c/Users/tejamukka/Desktop/genres.tar/genres2"
